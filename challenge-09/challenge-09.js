...
function calculator (num1, num2) {
    function returnedCallback (callback) {
...
`calculator`. E essa função espera um parâmetro `callback`.

 O `callback` tem dois parãmetros disponíveis, que são os números que você acabou de passar
...
var multiplication = calculator(6, 5);
var division = calculator(25, 5);
var mod = calculator(100, 30);
/*
...
chamada.
*/
console.log( 'O resultado da subtração é:', subtraction(function(num1, num2){ return num1 - num2; }) );
